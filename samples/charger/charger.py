...
class BalloonConfig(Config):
    ...
    # NUM_CLASSES = 1 + 80  # Background + balloon
...
class BalloonDataset(utils.Dataset):
    ...
    def load_balloon(self, dataset_dir, subset):
        ...
        self.add_class("charger", 1, "sharp")
        self.add_class("charger", 2, "google")
        self.add_class("charger", 3, "hp")
        self.add_class("charger", 4, "nokia")
        self.add_class("charger", 5, "razer")
        self.add_class("charger", 6, "ktec")
